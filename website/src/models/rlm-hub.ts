...
import '../../scripts/jquery-3.3.1';
import {Connection, Proxy, hubConnection} from '../../scripts/jquery.signalR-2.4.0';
import {Publisher} from '../models/publisher';
import {Tournament} from './tournament';

export class RlmCarsUpdatedEvent {
    tournamentId: number;
    cars: Array<Car>;
}

export class RlmCarUpdatedEvent {
    tournamentId: number;
    car: Car;
}

export class RlmRacesUpdatedEvent {
    tournamentId: number;
    racesData: RlmRacesData;
}

export class RlmCurrentRaceUpdatedEvent {
    tournamentId: number;
    race: Race;
}

export class RlmCarLaneAssignment {
    raceNum: number;
    laneNum: number;
...
export class RlmStandingsUpdatedEvent {
    tournamentId: number;
    standings: Array<Standing>;
}

export class RlmNextRacesUpdatedEvent {
    tournamentId: number;
    nextRaces: Array<Race>;
}

export class RlmHub extends Publisher {
    ...
    createTournament(name: string, numLanes: number): void {
        console.log("RlmHub:createTournament");
        this.proxy.invoke('RequestAddTournament', name, numLanes)
            .catch(function (e) { throw new Error('Create tournament failed: ' + e); });
    }
    ...
    requestGetTournaments(): void {
        console.log("RlmHub:requestGetTournaments");
        this.proxy.invoke('RequestGetTournaments')
            .catch(function (e) { throw new Error('Get tournaments failed: ' + e); });
    }
    ...
    requestUpdateTournament(id: number, name: string, numLanes: number): void {
        this.proxy.invoke('RequestUpdateTournament', id, name, numLanes)
            .catch(function (e) { throw new Error('Update tournament failed: ' + e); });
    }
    ...
    requestGetCars(tournamentId: number): void {
        this.proxy.invoke('RequestGetCars', tournamentId)
            .catch(function (e) { throw new Error('Get cars failed: ' + e); });
    }
    ...
    requestAddCar(tournamentId: number, car: Car): void {
        this.proxy.invoke('RequestAddCar', tournamentId, car)
            .catch(function (e) { throw new Error('Add car failed: ' + e); });
    }

    requestUpdateCar(tournamentId: number, car: Car): void {
        this.proxy.invoke('RequestUpdateCar', tournamentId, car)
            .catch(function (e) { throw new Error('Update car failed: ' + e); });
    }
    ...
    requestDeleteCar(tournamentId: number, carId: number) {
        this.proxy.invoke('RequestDeleteCar', tournamentId, carId)
            .catch(function (e) { throw new Error('Delete car failed: ' + e); });
    }

    requestGetRaces(tournamentId: number): void {
        this.proxy.invoke('RequestGetRaces', tournamentId)
            .catch(function (e) { throw new Error('Get races failed: ' + e); });
    }
    ...
    generateRaces(tournamentId: number): void {
        this.proxy.invoke('RequestGenerateRaces', tournamentId)
            .catch(function (e) { throw new Error('Generate races failed: ' + e); });
    }
    ...
    requestGetCurrentRace(tournamentId: number): void {
        this.proxy.invoke('RequestGetCurrentRace', tournamentId)
            .catch(function(e) { throw new Error('Get current race failed: ' + e); });
    }
    ...
    requestGetStandings(tournamentId: number): void {
        this.proxy.invoke('RequestGetStandings', tournamentId)
            .catch(function(e) { throw new Error('Get standings failed: ' + e); });
    }
    ...
    requestGetNextRaces(tournamentId: number): void {
        this.proxy.invoke('RequestGetNextRaces', tournamentId)
            .catch(function(e) { throw new Error('Get next races failed: ' + e); });
    }
